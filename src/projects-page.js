const PROJECTS = [
  ...
  { name: 'Bridal Boutique', url: 'https://xentrack.xenreality.com/dashboard/9vS8oJTD' },
  { name: 'EasyBuy',         url: 'https://ebsurecount.xenreality.com/' },
  { name: 'Emo Energy',      url: 'https://emo.xenreality.com/' },
  { name: 'Goyal Sons',      url: 'https://xentrack.xenreality.com/dashboard/gdxmnrYX' },
  ...
  { name: 'Laundry House',   url: 'https://xentrack.xenreality.com/dashboard/j4mut8PL' },
  ...
  { name: 'Reliance Demo',   url: 'https://test.xenreality.com/' },
